...
**Administrador del sistem:** Alberto Trujillo ITB2425  
**Correu electrònic:** [Contacte amb l'administrador]  
**Horari d'atenció:** Dilluns a divendres, 9:00 - 17:00  

### 7.2 Informació del projecte

**Repositori del projecte:** [2526-P0.0-ASIXc2BC-G05](https://github.com/AlbertoTrujillo-ITB2425/2526-P0.0-ASIXc2BC-G05)  
**Seguiment del projecte:** [Proofhub](https://itecbcn.proofhub.com/bapplite/#app/todos/project-9335566085/list-269936034851)

### 7.3 Reportar problemes

Quan contactis amb suport, proporciona:
1. **Descripció del problema** detallada
2. **Navegador i versió** que utilitzes
3. **Sistema operatiu**
4. **Missatges d'error** exactes (si n'hi ha)
5. **Passos per reproduir** el problema

### 7.4 Suggeriments i millores

Les teves opinions i suggeriments són importants per millorar el sistema. Pots enviar-les a través del repositori GitHub o contactant directament amb l'administrador.

---

## Informació tècnica resumida

**Versió del sistema:** 2526-P0.0-ASIXc2BC-G05  
**Data d'actualització:** 2025-11-11  
**Tecnologies utilitzades:** PHP, MySQL, Apache, HTTPS  
**Compatibilitat:** Navegadors moderns amb suport SSL/TLS  

---

**© 2025 - Sistema d'Equipaments Educatius - ITB Centre d'Estudis Tecnològics**